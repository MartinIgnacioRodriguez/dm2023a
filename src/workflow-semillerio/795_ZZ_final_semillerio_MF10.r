...
# PARAM$exp_input  <- "HT7510" # MR: Tomo como input el WK MF06
...
PARAM$experimento  <- "ZZ7950_MF10" #CAMBIO MR
# PARAM$exp_input  <- "HT7510" #CAMBIO MR
PARAM$exp_input  <- "HT7510_MF06" #CAMBIO MR
...
PARAM$semillerio  <- 100 #CAMBIO MR
