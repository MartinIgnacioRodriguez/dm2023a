...
PARAM  <- list()
# PARAM$experimento  <- "HT7510" #CAMBIO MR
PARAM$experimento  <- "HT7510_MF051" #CAMBIO MR

# PARAM$exp_input  <- "TS7410" #CAMBIO MR
PARAM$exp_input  <- "TS7410_MF051" #CAMBIO MR

PARAM$lgb_crossvalidation_folds  <- 5  #En caso que se haga cross validation, se usa esta cantidad de folds

# PARAM$lgb_semilla  <- 102191   #cambiar por su propia semilla #CAMBIO MR
PARAM$lgb_semilla  <- 100043   #cambiar por su propia semilla #CAMBIO MR
