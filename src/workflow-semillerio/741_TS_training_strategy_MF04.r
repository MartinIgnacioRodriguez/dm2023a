...
PARAM$experimento <- "TS7410_MF04" #CAMBIO MR
# PARAM$exp_input  <- "FE7310" #CAMBIO MR
PARAM$exp_input  <- "FE7310_MF04" #CAMBIO MR
...
# PARAM$train$undersampling  <- 0.4   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA #CAMBIO MR
PARAM$train$undersampling  <- 0.05   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA #CAMBIO MR
