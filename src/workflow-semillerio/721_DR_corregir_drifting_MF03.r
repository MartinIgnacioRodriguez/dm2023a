...
PARAM  <- list()
# PARAM$experimento  <- "DR7210" #CAMBIO MR
PARAM$experimento  <- "DR7210_MF03" #CAMBIO MR
# PARAM$exp_input  <- "CA7110" #CAMBIO MR
PARAM$exp_input  <- "CA7110_MF03" #CAMBIO MR

PARAM$variables_intrames  <- TRUE   # atencion esto esta en TRUE

#valores posibles  "ninguno" "rank_simple" , "rank_cero_fijo" , "deflacion"
# PARAM$metodo  <- "rank_cero_fijo" #CAMBIO MR
PARAM$metodo  <- "rank_simple" #CAMBIO MR
