...
# PARAM$exp_input  <- "HT7510" # MR: Tomo como input el WK MF01
...
PARAM$experimento  <- "ZZ7950_MF08" #CAMBIO MR
# PARAM$exp_input  <- "HT7510" #CAMBIO MR
PARAM$exp_input  <- "HT7510_MF01" #CAMBIO MR
...
PARAM$semillerio  <- 30   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad #CAMBIO MR
