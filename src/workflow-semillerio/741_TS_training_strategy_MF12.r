...
# PARAM$exp_input  <- "FE7310" # MR: Tomo como input el WK MF051
...
PARAM$experimento <- "TS7410_MF12" #CAMBIO MR
# PARAM$exp_input  <- "FE7310" #CAMBIO MR
PARAM$exp_input  <- "FE7310_MF051" #CAMBIO MR
...
# PARAM$train$validation   <- c( 202106 ) #CAMBIO MR
# PARAM$train$testing      <- c( 202107 ) #CAMBIO MR
PARAM$train$training     <- c( 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906 ) #CAMBIO MR
PARAM$train$validation   <- c( 202105 ) #CAMBIO MR
PARAM$train$testing      <- c( 202107,202106 ) #CAMBIO MR
