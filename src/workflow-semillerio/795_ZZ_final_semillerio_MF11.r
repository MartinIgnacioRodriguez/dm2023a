...
# PARAM$exp_input  <- "HT7510" # MR: Tomo como input el WK MF051
...
PARAM  <- list()
# PARAM$experimento  <- "ZZ7950" #CAMBIO MR
PARAM$experimento  <- "ZZ7950_MF11" #CAMBIO MR
# PARAM$exp_input  <- "HT7510" #CAMBIO MR
PARAM$exp_input  <- "HT7510_MF051" #CAMBIO MR
...
# PARAM$semillerio  <- 20   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad #CAMBIO MR
PARAM$semillerio  <- 100   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad #CAMBIO MR
# PARAM$semilla_primos  <- 102191  # se utiliza para generar el vector de  PARAM$semillerio  semillas #CAMBIO MR
PARAM$semilla_primos  <- 100043  # se utiliza para generar el vector de  PARAM$semillerio  semillas #CAMBIO MR
