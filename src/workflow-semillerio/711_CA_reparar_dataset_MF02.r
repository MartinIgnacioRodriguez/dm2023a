...
PARAM  <- list()
# PARAM$experimento  <- "CA7110" #CAMBIO MR
PARAM$experimento  <- "CA7110_MF02" #CAMBIO MR
PARAM$dataset  <- "./datasets/competencia_2023.csv.gz"

# El llamado “EstadisticaClasica” al valor que fue pisado en cero para ese mes, lo imputa como el
# promedio del mes anterior y siguiente.
# El llamado “MachineLearning” al valor que fue pisado en cero para ese mes, lo imputa con un NA.
# PARAM$metodo  <- "MachineLearning"     #valores posibles  "MachineLearning"  "EstadisticaClasica" "Ninguno" # CAMBIO MR
PARAM$metodo  <- "EstadisticaClasica"     #valores posibles  "MachineLearning"  "EstadisticaClasica" "Ninguno" # CAMBIO MR
