...
# PARAM$exp_input  <- "DR7210" MR: Tomo como input el WK MF05
...
PARAM$experimento <- "FE7310_MF051" #CAMBIO MR
# PARAM$exp_input  <- "DR7210" #CAMBIO MR
PARAM$exp_input  <- "FE7310_MF05" #CAMBIO MR

# PARAM$lag1  <- TRUE #CAMBIO MR
# PARAM$lag2  <- TRUE #CAMBIO MR
PARAM$lag1  <- FALSE #CAMBIO MR
PARAM$lag2  <- FALSE #CAMBIO MR
PARAM$lag3  <- FALSE

# PARAM$Tendencias1$run  <- TRUE #CAMBIO MR
PARAM$Tendencias1$run  <- FALSE #CAMBIO MR
