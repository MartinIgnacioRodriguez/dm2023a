...
# PARAM$final_train (+2 meses)
# PARAM$train$training (+2 meses)
...
PARAM  <- list()
# PARAM$experimento <- "TS7410" #CAMBIO MR
PARAM$experimento <- "TS7410_MF07" #CAMBIO MR
# PARAM$exp_input  <- "FE7310" #CAMBIO MR
PARAM$exp_input  <- "FE7310_MF01" #CAMBIO MR

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202109 )
# PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909 ) # CAMBIO MR
PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907 ) # CAMBIO MR

# PARAM$train$training     <- c( 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907 ) # CAMBIO MR
PARAM$train$training     <- c( 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905 ) # CAMBIO MR 
...
# PARAM$train$semilla  <- 102191  # cambiar por su propia semilla  !!! #CAMBIO MR
PARAM$train$semilla  <- 100043  # cambiar por su propia semilla  !!! #CAMBIO MR
