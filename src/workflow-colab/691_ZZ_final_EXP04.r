# EXP_03
# Se cambió el parámetro "weight" de la variable "dtrain" y se agregó en la variable "campos_buenos".
...
PARAM  <- list()
PARAM$experimento  <- "ZZ6910_EXP04"
PARAM$exp_input  <- "HT6510_EXP04"
...
PARAM$semillas  <- c( 100043, 100057, 100153, 100183, 100237 ) #reemplazar por las propias semillas
...
campos_buenos  <- setdiff( colnames(dataset), c( "clase_ternaria", "clase01", "weight") )
