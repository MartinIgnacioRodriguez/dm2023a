# EXP_01
# Queremos ver cómo es la performance del modelo sin excluir meses de pandemia.
# Se agregaron éstos 5 meses de pandemia tanto en PARAM$final_train como en PARAM$train$training:
# 202007, 202006, 202005, 202004, 202003
# En total estamos entrenando en 23 meses.
